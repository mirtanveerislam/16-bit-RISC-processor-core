...
#
# Generated by Vivado on Sun Dec 10 14:32:20 PST 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../risc_np.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/tanveer/risc/Non_Pipelined/vivado/risc_np.cache/compile_simlib/vcs"
  fi
