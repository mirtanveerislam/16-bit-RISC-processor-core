...
HD_PWD='/home/tanveer/risc/Non_Pipelined/vivado/risc_np.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log risc_soc_synth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source risc_soc_synth.tcl
