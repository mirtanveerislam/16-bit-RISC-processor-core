...
HD_PWD='/home/tanveer/risc/Non_Pipelined/vivado/risc_np.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log risc_soc_synth.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source risc_soc_synth.tcl -notrace
